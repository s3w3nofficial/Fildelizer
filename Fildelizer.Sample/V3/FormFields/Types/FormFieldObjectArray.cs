...
{
	/// <summary>
	/// FormField of type object array
	/// </summary>
	public class FormFieldObjectArray : FormFieldBase<ICollection<object>>, IFormField
	{
		/// <summary>
		...
		/// </summary>
		[JsonIgnore]
		public override FormFieldType Type => FormFieldType.ObjectArray;
	}
}
